...
import { formatDate, formatNumber, latestErrorSample, statusTone, summarizeUsage } from "../lib/format";
import { isAdmin, useSession } from "../lib/auth/session";
import type { AdminLimitState, DailyUsage, GatewayMetrics, OverviewResponse, RequestLog, UserLimitState } from "../types/api";

type OverviewData =
  | (OverviewResponse & { metrics: null; limits: UserLimitState })
  | { user: null; daily_usage: DailyUsage[]; recent_requests: RequestLog[]; metrics: GatewayMetrics; limits: AdminLimitState };
